...
const handleSubmit = async (e: any) => {
  e.preventDefault();
  const data = { nick_name, full_name, email, password };
  ...
  try {
    ...
    // Si la respuesta es correcta, redirija a /Home.
    if (response.ok) {
      window.location.href = "/Home";
      console.log("Redirecciónando a /home..")
    } else {
  ...
  return (
    <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <div>
            <label htmlFor="nick_name" className="block text-sm font-medium leading-6 text-gray-900">Nick Name</label>
            <div className="mt-2">
              <input id="nick_name" 
                    name="nick_name" 
                    type="text" 
